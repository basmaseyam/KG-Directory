...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <meta property="og:title" content="KG Directory" />
    <meta property="og:type" content="article" />
    <meta property="og:url" content="https://kiddy.com/" />
    <meta property="og:image" content="https://s3.amazonaws.com/creativetim_bucket/products/154/opt_md_laravel_thumbnail.jpg"/>
    <meta property="og:description" content="Kindergarten Direrctory" />
    <meta property="og:site_name" content="KGD" />

    <title>{{ __('KG Directory') }}</title>
